...
namespace ApiControllers.Models
{
	...
	{
		private Dictionary<Int32, Reservation> items;
		...
		public MemoryRepository()
		{
			...
			}.ForEach(reserv => AddReservation(reserv));
		}

		public Reservation this[Int32 id] => items.ContainsKey(id) ? items[id] : null;
